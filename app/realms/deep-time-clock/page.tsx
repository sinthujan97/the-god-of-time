...
export const metadata = {
  ...
  openGraph: { title: "Deep Time Earth Clock | The God of Time", url: "https://thegodoftime.com/realms/deep-time-clock" },
  alternates: { canonical: "https://thegodoftime.com/realms/deep-time-clock" },
};

...
export const metadata = {
  ...
  openGraph: { title: "Consumption Footprint | The God of Time", url: "https://thegodoftime.com/realms/consumption-footprint" },
  alternates: { canonical: "https://thegodoftime.com/realms/consumption-footprint" },
};
